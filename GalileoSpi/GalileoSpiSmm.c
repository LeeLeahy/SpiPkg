/** @file
  ...
  This module specifies the SPI busses on the Galileo board used in SMM
  mode.
...
#define SPI_FLASH_DRIVER_GUID                   gEfiSpiSmmNorFlashDriverGuid
  ...
  )
{
  ...
  //
  return SbcSmmInitialize(&SpiConfiguration);
}
