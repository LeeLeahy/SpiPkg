...
EFI_STATUS
EFIAPI
AdcComponentNameGetControllerName (
...
// Driver name table 
//
STATIC EFI_UNICODE_STRING_TABLE mAdc108s102DriverNameTable[] = {
  { "eng;en", L"Texas Instruments ADC108S102 Driver" },
  { NULL , NULL }
};
...
//
STATIC EFI_COMPONENT_NAME_PROTOCOL  mAdc108s102ComponentName = {
  (EFI_COMPONENT_NAME_GET_DRIVER_NAME) AdcComponentNameGetDriverName,
  (EFI_COMPONENT_NAME_GET_CONTROLLER_NAME) AdcComponentNameGetControllerName,
  "eng"
};
...
//
STATIC EFI_COMPONENT_NAME2_PROTOCOL mAdc108s102ComponentName2 = {
  ...
  )
{
  return LookupUnicodeString2 (
           ...
           mAdc108s102DriverNameTable,
           DriverName,
           (BOOLEAN)(This != &mAdc108s102ComponentName2)
           );
}
  ...
  )
{
  ...
  Status = AdcStartup (This, ControllerHandle);
  return Status;
}
...
DEBUG ((EFI_D_ERROR, "AdcDriverStop entered\n"));

  //
  // Determine if the driver is already shutdown
  //
DEBUG ((EFI_D_ERROR, "  Calling OpenProtocol(gTexasInstrumentsAdc108s102ProtocolGuid)\n"));
  Status = gBS->OpenProtocol (
                  ControllerHandle,
                  &gTexasInstrumentsAdc108s102ProtocolGuid,
                  (VOID **) &Adc108s102Protocol,
...
DEBUG ((EFI_D_ERROR, "  Status: %r\n", Status));
  ...
  //
  Status = AdcShutdown (Adc108s102Protocol);
DEBUG ((EFI_D_ERROR, "AdcDriverStop exiting, Status: %r\n", Status));
  return Status;
}

STATIC EFI_DRIVER_BINDING_PROTOCOL mAdc108s102DriverBinding = {
  AdcDriverSupported,
  AdcDriverStart,
  AdcDriverStop,
  0x10,
...
/**
  The entry point for the ADC108S102 analog to digital converter driver.
  ...
  )
{
  ...
  Status = EfiLibInstallDriverBindingComponentName2 (
             ImageHandle,
             SystemTable,
             &mAdc108s102DriverBinding,
             ImageHandle,
             &mAdc108s102ComponentName,
             &mAdc108s102ComponentName2
             );
