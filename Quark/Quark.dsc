...
[Defines]
  ...
  DEFINE SMM_ENABLED          = TRUE
  DEFINE SPIPKG_ENABLED       = TRUE
...
!if $(SPIPKG_ENABLED)
  !if $(SMM_ENABLED)
    PlatformHelperLib|SpiPkg/Quark/Smm/PlatformHelperLib/DxePlatformHelperLib.inf
  !else
    PlatformHelperLib|SpiPkg/Quark/NoSmm/PlatformHelperLib/DxePlatformHelperLib.inf
  !endif
!else
...
!if $(SPIPKG_ENABLED)
  !if $(SMM_ENABLED)
    PlatformHelperLib|SpiPkg/Quark/Smm/PlatformHelperLib/PeiPlatformHelperLib.inf
  !else
    PlatformHelperLib|SpiPkg/Quark/NoSmm/PlatformHelperLib/PeiPlatformHelperLib.inf
  !endif
!else
...
!endif
  ...
  !else
    SpiPkg/Quark/NoSmm/Setup/DxePlatform.inf
    SpiPkg/Quark/NoSmm/QNCInit/Dxe/QNCInitDxe.inf
  !endif
...
#    MdeModulePkg/Universal/Acpi/BootScriptExecutorDxe/BootScriptExecutorDxe.inf {
  ...
  !if $(SPIPKG_ENABLED)
    ...
    [LibraryClasses]
      ...
      !if $(SMM_ENABLED)
        SpiSmmBoardConfigurationLib|SpiPkg/Library/SpiSmmBoardConfiguration/SpiSmmBoardConfiguration.inf
      !endif

    [Components.IA32]
#      SpiPkg/VoltMeterDxe/VoltMeterDxe.inf
#      SpiPkg/Adc108s102Dxe/Adc108s102Dxe.inf
      SpiPkg/SpiFlash/SpiFlashDxe.inf
#      SpiPkg/ClockDxe/ClockDxe.inf
#      SpiPkg/Max6950Dxe/Max6950Dxe.inf
      SpiPkg/SpiBus/SpiBusDxe.inf
      SpiPkg/QuarkSpiDxe/QuarkSpiDxe.inf
      !if $(SMM_ENABLED)
        SpiPkg/Quark/Smm/SpiFvbServices/PlatformSpi.inf
        SpiPkg/Quark/Smm/SpiFvbServices/PlatformSmmSpi.inf
        SpiPkg/SpiFlash/SpiFlashSmm.inf
        SpiPkg/SpiBus/SpiBusSmm.inf
#        SpiPkg/GalileoSpi/GalileoSpiDxe.inf {
SpiPkg/GalileoSpi/GalileoSpi.inf {
          <LibraryClasses>
            MtrrLib|QuarkSocPkg/QuarkNorthCluster/Library/MtrrLib/MtrrLib.inf
            QNCAccessLib|QuarkSocPkg/QuarkNorthCluster/Library/QNCAccessLib/QNCAccessLib.inf
        }
        SpiPkg/GalileoSpi/GalileoSpiSmm.inf {
          <LibraryClasses>
            MtrrLib|QuarkSocPkg/QuarkNorthCluster/Library/MtrrLib/MtrrLib.inf
            QNCAccessLib|QuarkSocPkg/QuarkNorthCluster/Library/QNCAccessLib/QNCAccessLib.inf
        }
SpiPkg/QuarkLegacySpi/QuarkLegacySpiDxe.inf
        SpiPkg/QuarkLegacySpi/QuarkLegacySpiSmm.inf
      !else
        SpiPkg/Quark/NoSmm/SpiFvbServices/PlatformSpi.inf
        SpiPkg/GalileoSpi/GalileoSpi.inf {
          <LibraryClasses>
            MtrrLib|QuarkSocPkg/QuarkNorthCluster/Library/MtrrLib/MtrrLib.inf
            QNCAccessLib|QuarkSocPkg/QuarkNorthCluster/Library/QNCAccessLib/QNCAccessLib.inf
  ...
  !else
    ...
    !else
      SpiPkg/Quark/NoSmm/Spi/PchSpiRuntime.inf {
        <LibraryClasses>
          PciExpressLib|MdePkg/Library/DxeRuntimePciExpressLib/DxeRuntimePciExpressLib.inf
      }
    !endif
  ...
  !else
    SpiPkg/Quark/NoSmm/IohInit/Dxe/IohInitDxe.inf
  !endif
