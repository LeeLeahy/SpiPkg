...
################################################################################
[Defines]
  PLATFORM_NAME                       = QuarkCorebootSpi
  ...
  OUTPUT_DIRECTORY                    = Build/$(PLATFORM_NAME)IA32
  FLASH_DEFINITION                    = SpiPkg/Quark/CorebootPayloadPkg.fdf
...
[Components.IA32]
  ...
  # SPI support
  #
!include ../PI-Next/SpiPkg/Quark/SpiSupport.dsc
