...
[Defines]
  ...
  PLATFORM_NAME                  = QuarkSpi
  PLATFORM_GUID                  = F6E7730E-0C7A-4741-9DFC-6BC8B86CD865
  PLATFORM_VERSION               = 0.1
  FLASH_DEFINITION               = SpiPkg/Quark/$(PLATFORM_NAME).fdf
...
!if $(SMM_ENABLE)
  SpiPkg/Quark/Smm/QNCInit/Dxe/QNCInitDxe.inf
!else
...
!if $(SMM_ENABLE)
  ...
  SpiPkg/Quark/Smm/Setup/DxePlatform.inf
...
!if $(SMM_ENABLE)
  SpiPkg/Quark/Smm/IohInit/Dxe/IohInitDxe.inf
!else
...
!endif
  ...
  # SPI
  #
!include SpiPkg/Quark/SpiSupport.dsc
